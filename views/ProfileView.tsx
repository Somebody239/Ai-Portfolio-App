...
import { Loader2, Mail, GraduationCap, Target, User, BookOpen } from "lucide-react";
    ...
    <AppShell>
      <header className="flex flex-col gap-4 border-b border-zinc-900 pb-8 md:flex-row md:items-end md:justify-between">
        ...
        <div className="flex items-center gap-3">
          <InteractiveHoverButton text="Edit Profile" className="w-40" />
          ...
          <Card>
            ...
            <dl className="mt-6 grid grid-cols-1 gap-6 md:grid-cols-2">
              ...
              <div className="space-y-1">
                ...
                <dd className="text-sm text-white">Not set</dd>
              </div>
            </dl>
          </Card>
